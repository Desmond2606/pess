...
if (isset($_POST["btnUpdate"])){
	...
	if ($_POST["patrolCarStatus"] == '4'){
		...
		// First, retrive the incident ID from dispatch table handled by that patrol car
...
{ //post back here after clicking the btnSearch button
	...
	// if the patrol car does not exist, redirect back to upadte.php
	...
	// retrive from patrolcar_status table for populating the combo box
	...
	$patrolCarStatusArray;; //any arrary variable
	...
	?>
<!-- display a form for operator to upadte status of patrol car -->
